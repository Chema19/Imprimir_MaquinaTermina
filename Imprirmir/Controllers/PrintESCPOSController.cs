...
namespace Imprirmir.Controllers
{
    public class PrintESCPOSController : Controller
    {
        public ActionResult Index()
        {
            ViewBag.WCPScript = WebClientPrint.CreateScript(Url.Action("ProcessRequest", "WebClientPrintAPI", null, HttpContext.Request.Url.Scheme), Url.Action("PrintCommands", "PrintESCPOS", null, HttpContext.Request.Url.Scheme), HttpContext.Session.SessionID);
